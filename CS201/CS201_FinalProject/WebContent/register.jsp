...
<%
	...
	if(request.getAttribute("validPassword") != null){
		...
		if (validPassword == false) {
			errorMessage = "Passwords do not match or are left blank.";
		}
	}
%>
...
<html>
	<head>
		...
		<script>
		    ...
		    setInterval(function() {
		        flashtext('registerSubmit', '#C154C1');
		    }, 200 );
		    
		    setInterval(function() {
		        flashtext('confirmPasswordText', '#33CC99');
		    }, 225 );
		</script>
		<script>
...
<% } %>
		...
		<h3 class="confirmPasswordText" id="confirmPasswordText">Confirm Password</h3>
		<form method="POST" id="registerForm" action="CreateAccount">
			<input style="outline:none;" type="text" name="username" class="username" id="loginUsername"/> <br/> <br/>
			<input style="outline:none;" type="password" name="password" class="password" id="loginPassword"/> <br/> <br/>
			<input style="outline:none;" type="password" name="confirmPassword" class="confirmPassword" id="loginConfirmPassword"/> <br/> <br/>
			<input style="outline:none;" type="submit" name="registerSubmit" id="registerSubmit" class="registerSubmit" value="Register"/>
		</form>
	</body>
</html>
